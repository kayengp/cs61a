def divide(quotients, divisors):
    ...
    """
    return {q: [d for d in divide if d % q == 0] for q in quotients}
...
def distance(city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    lat_1 = get_lat(city_a)
    lat_2 = get_lat(city_b)
    lon_1 = get_lon(city_a)
    lon_2 = get_lon(city_b)
